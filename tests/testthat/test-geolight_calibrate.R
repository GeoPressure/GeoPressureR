...
test_that("geolight_map_calibrate() handles known/fixed/none", {
  ...
  p3 <- plot_twl_calib(tag, path = path, plot_plotly = FALSE)
  p4 <- plot_twl_calib_path(tag, path = path, plot_plotly = FALSE)

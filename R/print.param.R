...
print.param <- function(x, ...) {
  ...
  bullets(param$geopressure_map, "timeout")
  bullets(param$geopressure_map, "workers")
  bullets(param$geopressure_map, "era5_dataset")
  ...
  bullets(param$twilight_create, "transform_light")
  bullets(param$twilight_create, "twl_time_tolerance")
  bullets(param$tag_label_auto, "min_duration")
  bullets(param$tag_label_auto, "thr_reclassify")
  bullets(param$tag_label_auto, "post_proc_window")
  bullets(param$tag_stap_daily, "stap_long")
  bullets(param$tag_stap_daily, "stap_long_source")
  bullets(param$tag_stap_daily, "movement_period")
  bullets(param$tag_stap_daily, "max_twl_gap")
  ...
  bullets(param$graph_add_wind, "rounding_interval")
  bullets(param$graph_add_wind, "interp_spatial_linear")
  bullets(param$graph_add_wind, "pressure_source")
